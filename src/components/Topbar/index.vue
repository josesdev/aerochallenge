<template>
  <div :class="$style.headerContainer" class="p-0">
    <div :class="$style.topbar">
      <div class="mr-auto" v-if="!settings.isMobileView">
        <search/>
      </div>
      <div class="mr-auto">
        <div :class="$style.logo">
          <div :class="$style.logoContainer">
            <svg width="48px" height="48px" viewBox="0 0 39 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>Aerochallenge</title>
              <defs>
...
import BagMenu from '@/components/Topbar/BagMenu'
import HistoryMenu from '@/components/Topbar/HistoryMenu'
import Points from '@/components/Topbar/Points'
